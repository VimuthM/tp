...
import safeforhall.model.resident.UniqueResidentList;
...
public class AddressBook implements ReadOnlyAddressBook {
     ...
     * The resident identity of {@code editedResident} must not be the same as another
     * existing resident in the address book.
     */
